...
public class MongoDBService<T> where T : IIdentifiable
{
    ...
    public async Task<List<T>> GetBestSellingCoursesAsync()
    {
        ...
        else return await _collection.Find(filter).ToListAsync();
    }
    ...
    private async Task InitializeOnDbCreation()
    {
        ...
        {
            new Lesson { Name = "Mozart", VideoUrl = "https://www.youtube.com/watch?v=Ziai7G38giY", TextContent = "Content 1" },
            new Lesson { Name = "Nemchinskiy", VideoUrl = "https://www.youtube.com/watch?v=y4AvvI025oc", TextContent = "Content 2" },
            new Lesson { Name = "Nemchinskiy 2", VideoUrl = "https://www.youtube.com/watch?v=jipybKSCvJk", TextContent = "Content 3" },
            new Lesson { Name = "Nemchinskiy 3", VideoUrl = "https://www.youtube.com/watch?v=u7fpOY29Gxc", TextContent = "Content 4" },
            new Lesson { Name = "C vs C++ vs C#", VideoUrl = "https://www.youtube.com/watch?v=1KPEeOBl_X8", TextContent = "Content 5" },
            new Lesson { Name = "Mewing day 100", VideoUrl = "https://www.youtube.com/watch?v=FJ-IFxUp5Cg", TextContent = "Content 6" }
        };
